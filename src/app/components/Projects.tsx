...
type ProjectColor = 'blue' | 'purple' | 'green' | undefined;
...
const Projects = () => {
    ...
    const getGradientClass = (color: ProjectColor): string => {
        switch(color) {
            ...
            case 'purple': return 'from-yellow-500/20 to-yellow-600/20'
            case 'green': return 'from-emerald-500/20 to-emerald-700/20'
    ...
    const getBorderClass = (color: ProjectColor): string => {
        switch(color) {
            ...
            case 'purple': return 'border-yellow-500/30'
    ...
    const getTextClass = (color: ProjectColor): string => {
        switch(color) {
            ...
            case 'purple': return 'text-yellow-400'
